...
class SqlCache extends \BanditBB\Data\Cache\DataCache implements \BanditBB\Data\CacheStructure {
    ...
    private static function getCache( $table, $sorting ) {
        if ( $table == 'forums' ) {
            ...
            $sql = self::db()->query( self::queries()->selectForCacheCached( [ 'table' => $table, 'sorting' => $sorting ] ) );
        }
